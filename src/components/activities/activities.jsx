        ...
        <Container>
          <div className="d-flex flex-column">
            ...
            <Row className="mt-4">
              ...
              <Col xs={12}  sm={6} md={6} lg={4}>
                <ActivityItem background={bonfire} title="Aurora camp and dog sledding" href="/activities/aurora_camp"></ActivityItem>
              </Col>
              <Col xs={12}  sm={6} md={6} lg={4}>
          ...
          <div className="d-flex flex-column my-4">
            ...
            <Row className="mt-4">
              ...
              <Col xs={12}  sm={6} md={6} lg={4}>
                <ActivityItem background={husky_puppies} title="Puppy Café" href="/activities/husky_cafe"></ActivityItem>
              </Col>
            </Row>
          </div>
        </Container>
